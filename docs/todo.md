...
2. **Ввести "грейды" воркера** — один параметр, который задаёт сразу три связанных значения:
   перформанс, стоимость дня и отклонение. Сейчас они настраиваются по отдельности — грейд
   должен агрегировать их в единую сущность.
